...
namespace CS_ClassLibraryTester
{
    ...
    class NYX_Theme : ThemeContainer154
    {
        ...
        protected override void PaintHook()
        {
            ...
            if (Animated == true)
            {
                ...
                bg_cblend.Colors[1] = Color.SeaGreen;
            ...
            G.DrawString(Text, titleFont, new SolidBrush(Color.Cyan), new Point(m - (textWidth / 2), 4));
            //ÜSTTEKİ TEXT RENGİDİR
        }
    ...
    class NYX_ProgressBar : ThemeControl154
    {
        ...
        protected override void PaintHook()
        {
            ...
            ColorBlend bar_cblend = new ColorBlend(3);//PROGRESS BAR
            bar_cblend.Colors[0] = Color.FromArgb(x, y, z);
            bar_cblend.Colors[1] = Color.FromArgb(x, y, z);

            bar_cblend.Colors[2] = Color.FromArgb(x, y, z);
    ...
    class NYX_GroupBox : ThemeContainer154
    {
        ...
        protected override void PaintHook()
        {
            ...
            if (Animated == true)
            {
                ...
                y = rnd.Next(2);
                z = rnd.Next(10);
                text_cblend.Colors[0] = Color.FromArgb(ex, y, z);
                text_cblend.Colors[1] = Color.FromArgb(ex, y, z); ;//Genel Animasyon
                text_cblend.Colors[2] = Color.FromArgb(ex, y, z);
